...
class Noise(object):
    ...
    def run(self):
        ...
        #print background['CMB temp']
        #print coldoptics.keys()
        #print warmoptics.keys()
        ...
        t4L=Weff*NFdicT*np.power(1-COEmis, NmirrorsL)*DicT*FilT*CoT #Box left arm to detector 1
        t4R=Weff*NFdicT*np.power(1-COEmis, NmirrorsR)*DicT*FilT*CoR #Box right arm to detector 1
